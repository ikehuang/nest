...
function html_showcatalogs( $rows,  $pageNav,$sort,$cat_row){
	header("Location: /wp-admin/admin.php?page=catalogs_huge_it_catalog&task=edit_cat&id=8");
	exit;
	global $wpdb;
	?>
				...
				<div id="side-sortables" class="meta-box-sortables ui-sortable">
					...
					<ul id="catalog-unique-options-list">
						...
						<li style="display:none;">
							...
							<input disabled type = "text" name="name" id="huge_it_catalog_name" value="<?php echo esc_html(stripslashes($row->name));?>" onkeyup = "name_changeRight(this)">
						</li>
						...
						<div id="major-publishing-actions">
							...
							<input type="checkbox" id="ht_show_filtering"  <?php if($row->ht_show_filtering  == 'on'){ echo 'checked="checked"'; } ?>  name="ht_show_filtering" value="on" />
                                    ...
                                    <div class="postbox"  style="display:none;">
                                        ...
                                        <div style="display:none;" id="catalog-shortcode-box" class="postbox shortcode ms-toggle">
