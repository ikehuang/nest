...
?>	
		...
		<input type="button" onclick='advancesettingsvalidating()' class ="button button-primary" name="Submit" value="<?php _e('Save', 'simple-slideshow-manager' ) ?>" />
...
<!-- rename using ajax code start'shere       -->
<script>
...
//jQuery('#managegall_notice').html(theResponse);
});
}
