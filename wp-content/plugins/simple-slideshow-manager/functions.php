...
var framecode="<iframe id='youtube_url' src='http://www.youtube.com/embed/"+frame_id+"?autoplay=1&controls=0&wmode=opaque&cc_load_policy=1&iv_load_policy=3&loop=0' width='100%' height='100%'></iframe>";
...
var framecode="<iframe src='https://player.vimeo.com/video/"+vedio_id+"?player_id=player&autoplay=1&title=0&byline=0&portrait=0&loop=0' width='100%' height='100%'></iframe>";
...
<!--   Finnal Output  -->
<div id="image_slideshow_holder">
	<ul id='image_slideshow' class="acx_ppt acx_ppt_<?php echo $uid; ?> acx_ppt_uid_<?php echo$acx_gallery_uid; ?>" style="<?php if ($acx_slideshow_height != ""){ ?>height:<?php echo $acx_slideshow_height;?>; <?php }  if($acx_slideshow_width!="") { ?> width:<?php echo $acx_slideshow_width; ?>; <?php } if($acx_slideshow_height!=""&&$acx_slideshow_width!=""){ echo "overflow:hidden;"; }  ?>">
	<?php 
	for($i = 0 ; $i<$slide_count; $i++)
	{
		if($acx_slideshow_imageupload_complete_data[$gallery_name][$i]['type']=="image") 
		{
			...
			?>
			<li style="<?php if ($acx_slideshow_height != ""){ ?>height:<?php $acx_slideshow_height; ?>; <?php } ?>">
			...
			?>
			<img  src="<?php echo $acx_slideshow_imageupload_complete_data[$gallery_name][$i]['image_url']; ?>" title="<?php echo  $acx_slideshow_imageupload_complete_data[$gallery_name][$i]['image_title']; ?>" alt="<?php $acx_slideshow_imageupload_complete_data[$gallery_name][$i]['image_alttext']; ?>" style="<?php if ($acx_slideshow_height != ""){ ?>height:<?php echo $acx_slideshow_height;?>; <?php } ?>">
			<?php
			if($acx_slideshow_link_url!="")
			{
				?>
			...
			<!--div id='img_stop_<!--?php echo $uid; ?>' class='img_stop'></div>
			<div id='img_play_<!--?php echo $uid; ?>' class='img_play'></div-->
			</li>
			<?php
		}
		...
		{	
			...
			?>
			<li style="<?php if ($acx_slideshow_height != ""){ ?>height:<?php echo $acx_slideshow_height;?>;<?php } ?>">
			
			<div style="display:none;<?php if ($acx_slideshow_height != ""){ ?>height:<?php echo $acx_slideshow_height;?>;<?php } ?>" class="acx_v_hold" id="<?php echo $acx_slideshow_imageupload_complete_data[$gallery_name][$i]['vedio_id'].$uid.$i; ?>">
			...
			<img id="acx_image_<?php echo $uid; ?>_<?php echo $i; ?>" src="<?php echo $acx_slideshow_imageupload_complete_data[$gallery_name][$i]['thumbnail_image']; ?>" style="<?php if ($acx_slideshow_height != ""){ ?>height:<?php echo $acx_slideshow_height;?>; <?php } ?>" />
		...
		else if($acx_slideshow_imageupload_complete_data[$gallery_name][$i]['type']=="vimeo_video")
		{
			...
			<img  id="acx_image_vimeo_<?php echo $uid; ?>_<?php echo $i; ?>" src="<?php echo $acx_slideshow_imageupload_complete_data[$gallery_name][$i]['thumbnail_image']; ?>" style="<?php if ($acx_slideshow_height != ""){ ?>height:<?php echo $acx_slideshow_height;?>; <?php } ?>"/>
...
{
	cur_<?php echo $uid; ?>.fadeOut( <?php echo $acx_slideshow_fadeouttime ?> );
	if ( cur_<?php echo $uid; ?>.attr('class') == 'first' )
...
function acx_slideshow_ajax_editimage_callback()
{
	...
	$image_caption = $acx_slideshow_imageupload_complete_data[$gallery_name][$index]['image_caption'];
	...
	echo"<tr><td>". __('Image Caption','simple-slideshow-manager') ."</td><td><textarea id=\"acx_slideshow_edit_caption\" name=\"acx_slideshow_edit_caption\">".$image_caption."</textarea></td></tr>";
...
if($acx_slideshow_version < "2.0") // << Old Version // Current Verison
{
